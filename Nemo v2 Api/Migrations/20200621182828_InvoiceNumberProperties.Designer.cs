...
namespace Nemo_v2_Repo.Migrations
{
    ...
    [Migration("20200621182828_InvoiceNumberProperties")]
    partial class InvoiceNumberProperties
    {
            ...
            modelBuilder.Entity("Nemo_v2_Data.Entities.Restaurant", b =>
                {
                    ...
                    b.Property<decimal>("LastInvoiceNumber")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal>("LastWarehouseExportInvoiceNumber")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal>("LastWarehouseInsertInvoiceNumber")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));

                    b.Property<decimal>("LastWarehouseTransferInvoiceNumber")
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
